...
package com.yesspree.app.customviews.progressbar;
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    static final Interpolator EASE_INTERPOLATOR = new AccelerateDecelerateInterpolator();
     ...
     *
     * @param size One of {@link MaterialProgressDrawable} or
     *             {@link MaterialProgressDrawable}
     */
     ...
     * to a home_icn_user_details swipe gesture.
     *
     * @param colors
     */
    ...
    private static class Ring {
         ...
         *
         * @param width  Width of the hypotenuse of the icn_arrow_right head
         * @param height Height of the icn_arrow_right point
         */
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            //  c.drawCircle(startAngle, endAngle, 10, mPaint);
//            float startX = (float) (Math.cos(Math.toRadians(270)) * 15 + arcBounds.centerX());
//            float startY = (float) (Math.sin(Math.toRadians(270)) * 15 + arcBounds.centerY());
//            c.drawCircle(startX, startY, 10, mCirclePaint);
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (mShowArrow) {
                ...
                //when sweepAngle < 0 adjust the position of the icn_arrow_right
        ...
        /**
         * @param show Set to true to show the icn_arrow_right head on the progress spinner.
         */
