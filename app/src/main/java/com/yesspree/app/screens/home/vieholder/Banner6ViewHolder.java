...
public class Banner6ViewHolder extends MyViewHolder {
    ...
    String adapterType = "";
    public Banner6ViewHolder(View itemView, IAdapterClickListener adapterClickListener, String adapterType) {
        super(itemView);
